...
<div class="container">
  <div class="row">
    <div class="col-sm">
	<center><a href="#"><img src="imagens/upload.png" height="60" width="80"></a></center>
	<center><h6>Fazer Upload</h6></center>
      <h4>Inserir texto</h4>
	  <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Texto">
	  <select class="form-control" id="exampleFormControlSelect1">
      <option>Fonte Letra</option>
      <option>Arial</option>
      <option>New times</option>
      <option>Arimo</option>
      <option>Verdana</option>
    </select>
<select class="tamanho sm form-control form-control-sm">
  <option>10</option>
  <option>12</option>
  <option>13</option>
  <option>14</option>
...
<button type="button" class="up btn btn-dark">N</button>
<button type="button" class="up btn btn-dark">I</button>
<button type="button" class="up btn btn-dark">S</button>
<br>
<br>
<button type="button" class="btn btn-dark">Inserir</button>
</div>
    <div class="col-sm">
      <a href="#"><img src="imagens/estampabinario.png" height="200" width="200" style="border: #000000 Solid 2px;"></a>
	  </br>
	  </br>
	  <a href="#"><img src="imagens/estampasun.png" height="200" width="200" style="border: #000000 Solid 2px;"></a>
    </div>
    <div class="col-sm">
      <a href="#"><img src="imagens/estampabad.png" height="200" width="200" style="border: #000000 Solid 2px;"></a>
	  </br>
	  </br>
	  <a href="#"><img src="imagens/asas.jpg" height="200" width="200" style="border: #000000 Solid 2px;"></a>
    </div>
  </div>
</div>
